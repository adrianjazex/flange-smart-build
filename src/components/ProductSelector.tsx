...
const PRODUCT_TYPES = [
  "Under Over Tile Insert Kit with Push In Rubber Seal",
...
const PRODUCT_IMAGES = {
  "Under Over Tile Insert Kit with Push In Rubber Seal": underOverTileInsert,
                ...
                <Select onValueChange={(value) => updateSelection('type', value)} value={selection.type}>
                  ...
                  <SelectContent className="bg-background border-2 border-border z-50 max-w-md">
                    {PRODUCT_TYPES.map((type) => (
                      <SelectItem key={type} value={type} className="hover:bg-muted cursor-pointer px-4 py-3">
